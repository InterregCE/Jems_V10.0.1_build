    ...
    companion object {
        ...
        private val expectedOutput = ExpenditureCostCategoryBreakdown(
            ...
            total = ExpenditureCostCategoryBreakdownLine(
                ...
                currentReport = BigDecimal.valueOf(86966, 2),
                totalReportedSoFar = BigDecimal.valueOf(392966, 2),
                totalReportedSoFarPercentage = BigDecimal.valueOf(31188, 2),
                remainingBudget = BigDecimal.valueOf(-266966, 2),
            ),
        )
        ...
        private val expectedOnDirectOutput = ExpenditureCostCategoryBreakdown(
            ...
            total = ExpenditureCostCategoryBreakdownLine(
                ...
                totalEligibleBudget = BigDecimal.valueOf(1260),
                previouslyReported = BigDecimal.valueOf(3060),
                currentReport = BigDecimal.valueOf(94141, 2),
                totalReportedSoFar = BigDecimal.valueOf(400141, 2),
                totalReportedSoFarPercentage = BigDecimal.valueOf(31757, 2),
                remainingBudget = BigDecimal.valueOf(-274141, 2),
            ),
        )
        ...
        private val expectedOnStaffOutput = ExpenditureCostCategoryBreakdown(
            ...
            total = ExpenditureCostCategoryBreakdownLine(
                ...
                totalEligibleBudget = BigDecimal.valueOf(1260),
                previouslyReported = BigDecimal.valueOf(3060),
                currentReport = BigDecimal.valueOf(89966, 2),
                totalReportedSoFar = BigDecimal.valueOf(395966, 2),
                totalReportedSoFarPercentage = BigDecimal.valueOf(31426, 2),
                remainingBudget = BigDecimal.valueOf(-269966, 2),
            ),
        )
