...
internal class GetProjectPartnerReportProcurementSubcontractServiceTest : UnitTest() {
    ...
    @MockK
    lateinit var reportProcurementSubcontractPersistence: ProjectPartnerReportProcurementSubcontractPersistence
    ...
    fun getSubcontract() {
        ...
        assertThat(service.getSubcontract(PARTNER_ID, reportId = reportId, procurementId = procurementId))
            .containsExactly(
