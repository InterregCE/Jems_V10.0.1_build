...
internal class GetReportControlOverviewTest: UnitTest() {
    ...
    fun getWithLastCertifiedReport() {
        ...
        assertThat(interactor.get(PARTNER_ID, REPORT_ID)).isEqualTo(controlOverviewAfterLastCertified)
    }
    ...
    fun getFinalizedReport() {
        ...
        assertThat(interactor.get(PARTNER_ID, REPORT_ID)).isEqualTo(finalizedControlOverview)
    }
}
