...
class PaymentAccountAmountSummaryServiceTest: UnitTest() {
    ...
    @InjectMockKs
    lateinit var service: PaymentAccountAmountSummaryService
    ...
    fun getSummaryOverview() {
        ...
        Assertions.assertThat(service.getSummaryOverview(PAYMENT_ACCOUNT_ID)).isEqualTo(
