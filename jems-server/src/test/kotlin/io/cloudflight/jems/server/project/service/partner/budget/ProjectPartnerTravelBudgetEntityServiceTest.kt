...
//import io.cloudflight.jems.api.project.dto.partner.budget.InputTravelBudgetDTO
...
//internal class ProjectPartnerTravelBudgetEntityServiceTest {
//
//    companion object {
//
...
//
//    @MockK
//    lateinit var veryBigList: List<InputTravelBudgetDTO>
//
//    @MockK
...
//            .isEqualTo(
//                listOf(
//                    InputTravelBudgetDTO(id = 1, numberOfUnits = BigDecimal.valueOf(TO_CHANGE_NUM_OF_UNITS_OLD), pricePerUnit = BigDecimal.valueOf(TO_CHANGE_PRICE_PER_UNIT_OLD), rowSum = BigDecimal.valueOf(TO_CHANGE_ROW_SUM_OLD)),
//                    InputTravelBudgetDTO(id = 2, numberOfUnits = BigDecimal.valueOf(TO_STAY_NUM_OF_UNITS), pricePerUnit = BigDecimal.valueOf(TO_STAY_PRICE_PER_UNIT), rowSum = BigDecimal.valueOf(TO_STAY_ROW_SUM)),
//                    InputTravelBudgetDTO(id = 3, numberOfUnits = BigDecimal.valueOf(1.00), pricePerUnit = BigDecimal.valueOf(1000000.1), rowSum = BigDecimal.valueOf(1000000.1))
//                )
//            )
//
//        // clean context
...
//            // updated existing
//            InputTravelBudgetDTO(id = 1, numberOfUnits = BigDecimal.valueOf(TO_CHANGE_NUM_OF_UNITS_NEW), pricePerUnit = BigDecimal.valueOf(TO_CHANGE_PRICE_PER_UNIT_NEW)),
//            // no change for existing
//            InputTravelBudgetDTO(id = 2, numberOfUnits = BigDecimal.valueOf(TO_STAY_NUM_OF_UNITS), pricePerUnit = BigDecimal.valueOf(TO_STAY_PRICE_PER_UNIT)),
//            // new to be created
//            InputTravelBudgetDTO(id = null, numberOfUnits = BigDecimal.valueOf(550), pricePerUnit = BigDecimal.valueOf(10.0))
//        )
//
//        every { repository.findAllByPartnerIdOrderByIdAsc(1) } returns existing
//        every { repository.deleteAll(any<List<ProjectPartnerBudgetTravelEntity>>()) } answers {}
...
//        ).isEqualTo(
//            listOf(
//                InputTravelBudgetDTO(id = 1, numberOfUnits = toBd(TO_CHANGE_NUM_OF_UNITS_NEW), pricePerUnit = toBd(TO_CHANGE_PRICE_PER_UNIT_NEW), rowSum = toBd(TO_CHANGE_ROW_SUM_NEW)),
//                InputTravelBudgetDTO(id = 2, numberOfUnits = toBd(TO_STAY_NUM_OF_UNITS), pricePerUnit = toBd(TO_STAY_PRICE_PER_UNIT), rowSum = toBd(TO_STAY_ROW_SUM)),
//                // here there should be id=4 normally
//                InputTravelBudgetDTO(id = 0, numberOfUnits = toBd(550.0), pricePerUnit = toBd(10.0), rowSum = toBd(5500.0))
//            )
//        )
//
...
//        partnerId: Long,
//        toBeSaved: List<InputTravelBudgetDTO>
//    ): List<InputTravelBudgetDTO> {
