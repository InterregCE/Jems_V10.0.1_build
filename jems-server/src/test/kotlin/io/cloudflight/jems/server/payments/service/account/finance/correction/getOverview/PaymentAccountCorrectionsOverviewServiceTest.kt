...
class PaymentAccountCorrectionsOverviewServiceTest : UnitTest() {
    ...
    @MockK
    private lateinit var correctionLinkingPersistence: PaymentAccountCorrectionLinkingPersistence

    @InjectMockKs
    private lateinit var service: PaymentAccountCorrectionsOverviewService
    ...
    fun `getCurrentOverview - Draft`(status: PaymentAccountStatus) {
        ...
        Assertions.assertThat(service.getCurrentOverview(PAYMENT_ACCOUNT_ID)).isEqualTo(
