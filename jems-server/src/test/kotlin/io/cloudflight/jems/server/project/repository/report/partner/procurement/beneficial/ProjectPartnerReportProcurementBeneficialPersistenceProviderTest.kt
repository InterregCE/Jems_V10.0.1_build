...
class ProjectPartnerReportProcurementBeneficialPersistenceProviderTest : UnitTest() {
    ...
    @InjectMockKs
    lateinit var persistence: ProjectPartnerReportProcurementBeneficialPersistenceProvider

    @BeforeEach
    fun reset() {
        clearMocks(reportProcurementRepository, reportProcurementBeneficialRepository)
    }
