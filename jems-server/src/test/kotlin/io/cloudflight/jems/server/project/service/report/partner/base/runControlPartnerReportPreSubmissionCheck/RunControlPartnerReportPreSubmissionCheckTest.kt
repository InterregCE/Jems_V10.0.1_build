package io.cloudflight.jems.server.project.service.report.partner.base.runControlPartnerReportPreSubmissionCheck
...
import io.cloudflight.jems.server.project.service.report.partner.control.overview.runControlPartnerReportPreSubmissionCheck.RunControlPartnerReportPreSubmissionCheck
...
class RunControlPartnerReportPreSubmissionCheckTest: UnitTest() {

    @MockK
    private lateinit var reportPersistence: ProjectPartnerReportPersistence
    @MockK
    private lateinit var service: RunControlPartnerReportPreSubmissionCheckService

    @InjectMockKs
    private lateinit var interactor: RunControlPartnerReportPreSubmissionCheck
