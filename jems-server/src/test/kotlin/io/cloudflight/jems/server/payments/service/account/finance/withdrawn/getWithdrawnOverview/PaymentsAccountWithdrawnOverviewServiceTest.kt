...
class PaymentsAccountWithdrawnOverviewServiceTest : UnitTest() {
    companion object {
    ...
    @MockK
    private lateinit var persistence: PaymentAccountPersistence
    @MockK
    private lateinit var financePersistence: PaymentAccountFinancePersistence

    @InjectMockKs
    private lateinit var service: PaymentsAccountWithdrawnOverviewService
    ...
    fun getWithdrawnOverview() {
        ...
        Assertions.assertThat(service.getWithdrawnOverview(98L)).containsExactly(
            expectedPo1,
            expectedPo2,
        )
    }
