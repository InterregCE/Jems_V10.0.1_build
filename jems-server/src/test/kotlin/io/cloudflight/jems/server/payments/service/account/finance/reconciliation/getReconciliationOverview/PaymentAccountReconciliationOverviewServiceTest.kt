...
class PaymentAccountReconciliationOverviewServiceTest : UnitTest() {
    ...
    @InjectMockKs
    lateinit var service: PaymentAccountReconciliationOverviewService
    ...
    fun getReconciliationOverview() {
        ...
        Assertions.assertThat(service.getReconciliationOverview(PAYMENT_ACCOUNT_ID)).isEqualTo(expectedReconciledAmounts)
    }
}
