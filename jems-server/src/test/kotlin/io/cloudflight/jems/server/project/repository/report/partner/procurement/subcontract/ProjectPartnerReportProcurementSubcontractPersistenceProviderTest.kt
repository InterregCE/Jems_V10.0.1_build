...
class ProjectPartnerReportProcurementSubcontractPersistenceProviderTest : UnitTest() {
    ...
    @InjectMockKs
    lateinit var persistence: ProjectPartnerReportProcurementSubcontractPersistenceProvider
