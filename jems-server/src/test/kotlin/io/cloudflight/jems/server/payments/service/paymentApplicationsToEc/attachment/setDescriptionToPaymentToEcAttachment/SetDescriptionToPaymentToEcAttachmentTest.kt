...
class SetDescriptionToPaymentToEcAttachmentTest : UnitTest() {
    ...
    @InjectMockKs
    lateinit var interactor: SetDescriptionToPaymentToEcAttachment
    ...
    @Test
    fun setDescription() {
        every { filePersistence.existsFile(JemsFileType.PaymentToEcAttachment, 92L) } returns true
    ...
    fun `setDescription - not existing`() {
        every { filePersistence.existsFile(JemsFileType.PaymentToEcAttachment, -1L) } returns false
