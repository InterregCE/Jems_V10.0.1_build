...
class GetProjectPartnerReportProcurementByIdException(cause: Throwable) : ApplicationException(
    code = "$GET_PROJECT_PARTNER_REPORT_PROCUREMENT_ERROR_CODE_PREFIX-BYID",
