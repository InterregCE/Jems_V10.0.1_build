...
class InvalidFieldStatusException(invalidConfigs: List<ApplicationFormFieldConfiguration>) :
        ...
        formErrors = mapOf(*invalidConfigs.map {
            Pair(
                ...
                I18nMessage(
                    ...
                    mapOf("fieldId" to it.id, "validStatuses" to it.getValidVisibilityStatusSet().toString())
                )
            )
        }.toTypedArray())
    )
