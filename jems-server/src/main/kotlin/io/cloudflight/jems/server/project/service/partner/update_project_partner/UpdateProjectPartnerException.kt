...
class InvalidProjectPartnerAddressesException : ApplicationUnprocessableException(
    code = "$UPDATE_PROJECT_PARTNER_ERROR_CODE_PREFIX-005",
    i18nMessage = I18nMessage("$UPDATE_PROJECT_PARTNER_ERROR_KEY_PREFIX.addresses.invalid.values")
)
