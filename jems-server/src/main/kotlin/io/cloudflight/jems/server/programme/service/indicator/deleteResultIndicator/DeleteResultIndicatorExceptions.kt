...
class ResultIndicatorDeletionFailed(cause: Throwable) : ApplicationException(
    code = DELETE_RESULT_INDICATOR_ERROR_CODE_PREFIX,
    i18nMessage = I18nMessage("$DELETE_RESULT_INDICATOR_ERROR_KEY_PREFIX.failed"),
    cause = cause
)

class ResultIndicatorDeletionWhenProgrammeSetupRestricted : ApplicationBadRequestException(
