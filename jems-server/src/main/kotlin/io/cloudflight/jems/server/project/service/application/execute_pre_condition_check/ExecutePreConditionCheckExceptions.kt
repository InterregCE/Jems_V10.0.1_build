...
class PreConditionCheckCannotBeExecutedException : ApplicationBadRequestException(
    code = "$EXECUTE_PRE_CONDITION_CHECK_ERROR_CODE_PREFIX-001",
    i18nMessage = I18nMessage("$EXECUTE_PRE_CONDITION_CHECK_ERROR_KEY_PREFIX.cannot.be.executed")
)
