...
class PaymentAdvanceController(
    ...
    override fun getAdvancePayments(pageable: Pageable, searchRequest: AdvancePaymentSearchRequestDTO?) =
        getAdvancePayments.list(pageable, (searchRequest ?: AdvancePaymentSearchRequestDTO()).toModel()).map { it.toDTO() }
