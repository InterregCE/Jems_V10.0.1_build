...
fun FinancingSourceBreakdownLine.toEntity(
...
fun FinancingSourceBreakdownLine.toSpfEntity(
...
fun List<ProjectReportVerificationCertificateSpfContributionOverviewEntity?>.toSpfSplitLineModelList() = this.map {
    FinancingSourceBreakdownSplitLine(
        fundId = it?.programmeFund!!.id,
        value = it.fundValue!!,
        partnerContribution = it.partnerContribution,
...
fun List<FinancingSourceBreakdownSplitLine>.toSpfEntities(
    projectReport: ProjectReportEntity,
    fundsResolver: (fundId: Long) -> ProgrammeFundEntity
) = map {
    ProjectReportVerificationCertificateSpfContributionOverviewEntity(
...
fun List<ProjectReportVerificationCertificateSpfContributionOverviewEntity>.toModel(partnerId: Long?) = map {
    PartnerCertificateFundSplit(
