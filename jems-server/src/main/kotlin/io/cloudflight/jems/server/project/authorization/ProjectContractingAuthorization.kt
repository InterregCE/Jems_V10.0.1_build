...
@PreAuthorize("@projectContractingAuthorization.canViewContractsAndAgreements(#projectId)")
annotation class CanViewContractsAndAgreements

@Retention(AnnotationRetention.RUNTIME)
@PreAuthorize("@projectContractingAuthorization.canEditContractsAndAgreements(#projectId)")
annotation class CanEditContractsAndAgreements

@Retention(AnnotationRetention.RUNTIME)
@PreAuthorize("@projectContractingAuthorization.canViewProjectManagers(#projectId)")
annotation class CanViewProjectManagers

@Retention(AnnotationRetention.RUNTIME)
@PreAuthorize("@projectContractingAuthorization.canEditProjectManagers(#projectId)")
...
@Retention(AnnotationRetention.RUNTIME)
@PreAuthorize("@projectContractingAuthorization.canEditReportingSchedule(#projectId)")
annotation class CanEditProjectReportingSchedule

@Component
class ProjectContractingAuthorization(
