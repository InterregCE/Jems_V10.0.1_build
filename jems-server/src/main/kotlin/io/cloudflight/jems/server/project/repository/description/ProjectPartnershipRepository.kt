...
@Repository
interface ProjectPartnershipRepository : PagingAndSortingRepository<ProjectPartnershipEntity, Long> {

    fun findFirstByProjectId(projectId: Long): ProjectPartnershipEntity?
    ...
    @Query(
        """
            SELECT
             ...
             translation.project_partnership AS projectPartnership
    ...
    fun findByProjectIdAsOfTimestamp(projectId: Long, timestamp: Timestamp): List<ProjectPartnershipRow>
