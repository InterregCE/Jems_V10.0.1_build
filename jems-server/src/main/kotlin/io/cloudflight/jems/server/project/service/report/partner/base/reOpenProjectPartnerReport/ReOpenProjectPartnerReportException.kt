...
private const val ERROR_CODE_PREFIX = "S-RPPR"
private const val ERROR_KEY_PREFIX = "use.case.reopen.project.partner.report"

class ReOpenProjectPartnerReportException(cause: Throwable) : ApplicationException(
