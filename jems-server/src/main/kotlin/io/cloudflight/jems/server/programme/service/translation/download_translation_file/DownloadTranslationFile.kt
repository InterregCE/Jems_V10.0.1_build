...
class DownloadTranslationFile(
    ...
    @CanRetrieveProgrammeSetup
    @ExceptionWrapper(DownloadDefaultTranslationFileFailed::class)
    override fun downloadDefaultEnTranslationFile(fileType: TranslationFileType): ByteArray =
        translationFilePersistence.getDefaultEnTranslationFile(fileType)
