...
const val CLONE_CHECKLIST_INSTANCE_ERROR_CODE_PREFIX = "S-V-CCIL"
const val CLONE_CHECKLIST_INSTANCE_ERROR_KEY_PREFIX = "use.case.clone.verification.checklist.instance"

class CloneVerificationChecklistInstanceException(cause: Throwable) : ApplicationException(
...
class CloneVerificationChecklistInstanceStatusNotAllowedException : ApplicationUnprocessableException(
