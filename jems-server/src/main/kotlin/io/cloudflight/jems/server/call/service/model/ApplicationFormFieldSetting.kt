...
enum class ApplicationFormFieldSetting(val id: String, val validVisibilityStatusSet: Set<FieldVisibilityStatus>) {
    ...
    PARTNER_VAT_RECOVERY("application.config.project.partner.recoverVat",
        setOf(FieldVisibilityStatus.STEP_ONE_AND_TWO, FieldVisibilityStatus.STEP_TWO_ONLY)),
    PARTNER_MAIN_ADDRESS_COUNTRY("application.config.project.partner.main-address.country",
        setOf(FieldVisibilityStatus.STEP_ONE_AND_TWO, FieldVisibilityStatus.STEP_TWO_ONLY)),
    PARTNER_MAIN_ADDRESS_NUTS2("application.config.project.partner.main-address.region2",
        setOf(FieldVisibilityStatus.STEP_ONE_AND_TWO, FieldVisibilityStatus.STEP_TWO_ONLY)),
    PARTNER_MAIN_ADDRESS_NUTS3("application.config.project.partner.main-address.region3",
        setOf(FieldVisibilityStatus.STEP_ONE_AND_TWO, FieldVisibilityStatus.STEP_TWO_ONLY)),
    ...
    PARTNER_MAIN_ADDRESS_HOMEPAGE("application.config.project.partner.main-address.homepage",
        setOf(FieldVisibilityStatus.STEP_ONE_AND_TWO, FieldVisibilityStatus.STEP_TWO_ONLY)),
    PARTNER_SECONDARY_ADDRESS_COUNTRY("application.config.project.partner.secondary-address.country",
        setOf(FieldVisibilityStatus.STEP_ONE_AND_TWO, FieldVisibilityStatus.STEP_TWO_ONLY)),
    PARTNER_SECONDARY_ADDRESS_NUTS2("application.config.project.partner.secondary-address.region2",
        setOf(FieldVisibilityStatus.STEP_ONE_AND_TWO, FieldVisibilityStatus.STEP_TWO_ONLY)),
    PARTNER_SECONDARY_ADDRESS_NUTS3("application.config.project.partner.secondary-address.region3",
        setOf(FieldVisibilityStatus.STEP_ONE_AND_TWO, FieldVisibilityStatus.STEP_TWO_ONLY)),
