...
import io.cloudflight.jems.server.notification.inApp.service.model.NotificationType.Companion.projectFileVerificationCommunicationNotifications
...
class UpdateProjectReportNotificationConfigurations(
    ...
    private fun validateConfiguration(projectNotificationConfigurations: List<ProjectNotificationConfiguration>) {
        val invalidConfigurations = projectNotificationConfigurations
            .filter { it.id !in (projectReportNotifications union projectFileVerificationCommunicationNotifications)}
