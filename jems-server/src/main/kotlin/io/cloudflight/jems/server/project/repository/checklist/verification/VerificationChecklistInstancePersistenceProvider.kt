package io.cloudflight.jems.server.project.repository.checklist.verification
...
@Repository
class VerificationChecklistInstancePersistenceProvider(
    private val repository: ChecklistInstanceRepository
) : VerificationChecklistInstancePersistence {
