...
class ProjectReportVerificationOverviewRestricted : ApplicationAccessDeniedException(
    code = "$GET_PROJECT_REPORT_FINANCING_SOURCE_BREAKDOWN_ERROR_CODE_PREFIX-002",
    i18nMessage = I18nMessage("$GET_PROJECT_REPORT_FINANCING_SOURCE_BREAKDOWN_ERROR_KEY_PREFIX.restricted"),
)
