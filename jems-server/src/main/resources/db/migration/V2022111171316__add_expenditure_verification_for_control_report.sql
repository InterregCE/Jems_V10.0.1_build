ALTER TABLE report_project_partner_expenditure
    ADD COLUMN part_of_sample BOOLEAN DEFAULT FALSE AFTER declared_amount_after_submission,
    ...
    ADD CONSTRAINT fk_partner_report_expenditure_to_typology_of_error
