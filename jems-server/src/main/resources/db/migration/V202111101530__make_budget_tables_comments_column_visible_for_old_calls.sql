UPDATE application_form_field_configuration
SET id='application.config.project.partner.budget.staff.cost.comments'
WHERE id = 'application.config.project.partner.budget.staff.cost.comment';
