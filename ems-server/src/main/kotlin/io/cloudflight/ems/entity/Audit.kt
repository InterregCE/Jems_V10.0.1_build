...
data class Audit(
    ...
    companion object {
        ...
        fun userCreated(currentUser: CurrentUser?, createdUser: OutputAccount): Audit {
            ...
            return Audit(
                ...
                projectId = null,
                username = author,
                description = "new user ${createdUser.email} with role ${createdUser.accountRole.name} has been created by $author"
            )
        }
