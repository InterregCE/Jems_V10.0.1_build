...
} from './programme-page/containers/programme-indicators-overview-page/programme-indicators-overview-page.component';
...
} from './programme-page/components/programme-output-indicator-detail/programme-output-indicator-detail.component';
import {
  ProgrammeOutputIndicatorSubmissionPageComponent
} from './programme-page/containers/programme-output-indicator-submission-page/programme-output-indicator-submission-page.component';
import {
  ProgrammeResultIndicatorSubmissionPageComponent
} from './programme-page/containers/programme-result-indicator-submission-page/programme-result-indicator-submission-page.component';
import {
  ProgrammeResultIndicatorDetailComponent
} from './programme-page/components/programme-result-indicator-detail/programme-result-indicator-detail.component';
...
} from './programme-page/containers/programme-simplified-cost-options/programme-simplified-cost-options.component';
...
} from './programme-page/containers/programme-lump-sums-submission-page/programme-lump-sums-submission-page.component';
...
} from './programme-page/containers/programme-unit-costs-submission-page/programme-unit-costs-submission-page.component';
import {
  ProgrammePriorityDetailPageComponent
} from './priorities/programme-priority-list-page/programme-priority-detail-page/programme-priority-detail-page.component';
...
import {ProgrammeTypologyErrorsComponent} from './programme-page/containers/programme-typology-errors/programme-typology-errors.component';
import {ProgrammeTypologyErrorsListComponent} from './programme-page/components/programme-typology-errors-list/programme-typology-errors-list-component';
