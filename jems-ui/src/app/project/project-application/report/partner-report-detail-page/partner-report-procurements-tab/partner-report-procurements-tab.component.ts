  ...
  addNewProcurement(procurement?: ProjectPartnerReportProcurementDTO): void {
    if (this.procurements.length <= this.constants.MAX_NUMBER_OF_ITEMS) {
      const item = this.formBuilder.group({
        ...
        contractAmount: this.formBuilder.control(procurement?.contractAmount || '', this.constants.CONTRACT_AMOUNT.validators),
        currency: this.formBuilder.control(['EUR'], this.constants.CURRENCY.validators),
