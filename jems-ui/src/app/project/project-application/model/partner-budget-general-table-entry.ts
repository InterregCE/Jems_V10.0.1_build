...
export class PartnerBudgetGeneralTableEntry implements PartnerBudgetTableEntry {
  id?: number;
  ...
  constructor(data: Partial<PartnerBudgetGeneralTableEntry>,
  ...
  getDescription(): string {
    return this.description[this.description.findIndex(lang => lang.language === InputTranslation.LanguageEnum.EN)]
      .translation;
  }
