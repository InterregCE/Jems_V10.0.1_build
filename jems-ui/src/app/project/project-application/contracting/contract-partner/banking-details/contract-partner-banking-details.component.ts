...
export class ContractPartnerBankingDetailsComponent {
    ...
    constructor(
        ...
        this.data$ = combineLatest([
            ...
            map(([bankingDetails, nuts, canEdit, canView, partnerSummary, isPartnerLocked]) => ({
                bankingDetails,
                nuts,
                canEdit,
                canView,
            ...
            tap(data => this.resetForm(data.bankingDetails, data.canEdit, data.isPartnerLocked))
        );
    }
    ...
    resetForm(bankingDetails: ContractingPartnerBankingDetailsDTO, editable = false, isPartnerLocked: boolean) {
        this.formService.setEditable(editable && !isPartnerLocked);
