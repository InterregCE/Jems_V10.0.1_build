      ...
      cy.fixture('project/application-form/project-partners/TB-772.json').then(testData => {
        ...
        cy.create2StepCall(call2step, user.programmeUser.email).then(callId => {
          ...
          cy.createApplication(application2step).then(applicationId => {
            ...
            cy.contains('mat-row', 'LP1').contains( 'delete').click();
            ...
            cy.contains('mat-row', 'PP3').should('contain', 'delete');
            cy.contains('mat-row', 'PP2').should('contain', 'delete');
            cy.contains('Deactivate partner').should('not.exist');
            ...
            cy.contains('div', 'Abbreviated name of the organisation').find('input').type(testData.fourthPartner.abbreviation);
            cy.contains('div', 'Legal status').find('mat-select').click();
