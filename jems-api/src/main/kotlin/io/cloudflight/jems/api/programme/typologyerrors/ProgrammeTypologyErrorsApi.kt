...
interface ProgrammeTypologyErrorsApi {
    ...
    @GetMapping(ENDPOINT_API_TYPOLOGY_ERRORS)
    fun getTypologyErrors(): List<TypologyErrorsDTO>

    @ApiOperation("Specify typology errors for this programme")
    @PutMapping(ENDPOINT_API_TYPOLOGY_ERRORS, consumes = [MediaType.APPLICATION_JSON_VALUE])
    fun updateTypologyErrors(@RequestBody typologyErrors: TypologyErrorsUpdateDTO): List<TypologyErrorsDTO>
