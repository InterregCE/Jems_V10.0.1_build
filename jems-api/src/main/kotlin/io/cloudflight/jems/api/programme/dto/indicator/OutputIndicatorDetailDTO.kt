...
data class OutputIndicatorDetailDTO(
    ...
    fun getDiff(other: OutputIndicatorDetailDTO): Map<String, Pair<Any?, Any?>> {
        ...
        if (resultIndicatorId != other.resultIndicatorId) {
            changes["resultIndicatorId"] = Pair(resultIndicatorId, other.resultIndicatorId)
        }
        return changes
    }
}
