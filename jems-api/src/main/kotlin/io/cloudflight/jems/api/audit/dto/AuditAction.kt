...
enum class AuditAction {
    ...
    @Deprecated("Kept for backwards compatibility.Use PROJECT_USER_ASSIGNMENT_APPLICANTS & PROJECT_USER_ASSIGNMENT_PROGRAMME instead")
    PROJECT_USER_ASSIGNMENT,
    @Deprecated("Kept for backwards compatibility.Use PROJECT_USER_ASSIGNMENT_APPLICANTS instead")
    PROJECT_LEAD_APPLICANT_ASSIGNMENT,
    ...
    PROJECT_AUDIT_CONTROL_IS_REOPENED,
    ...
    PROJECT_REPORT_VERIFICATION_REOPENED,
    ...
    PAYMENT_APPLICATION_TO_EC_AUDIT_EXPORT_TRIGGERED,
    PAYMENT_APPLICATION_TO_EC_FILE_UPLOADED_SUCCESSFULLY,
